...
public class C03_StaticKeyword {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("obj1.id = " + obj3.id);
        System.out.println("obj1.id = " + obj4.id);
        System.out.println("obj1.id = " + obj5.id);


        System.out.println("obj1.mevcut = " + obj1.mevcut);
        System.out.println("obj1.mevcut = " + obj2.mevcut);
        System.out.println("obj1.mevcut = " + obj3.mevcut);
        System.out.println("obj1.mevcut = " + obj4.mevcut);
        System.out.println("obj1.mevcut = " + obj5.mevcut);
