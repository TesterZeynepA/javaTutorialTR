...
*/
    ...
    private static void testPuanHesapla(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i <answers.length ; i++) {//herbir ogrenciyi tekrara alır

            int puan =0;

            for (int j = 0; j < answers[i].length; j++) {//tekrardaki herbir öğrenci cevapları alınır
            ...
            System.out.println((i+1) + ". ögrencinin puanı = " + puan);
        }
