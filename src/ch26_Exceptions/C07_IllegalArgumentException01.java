      ...
      //  }else System.out.println("mekanin sahibi geldi");
        ...
        try{
            if (yas<18){
                System.out.println("yasiniz " +yas+ " giris yapamazsiniz");
                throw new IllegalArgumentException();
                //hata new leyerek, cathc blogunu da çalıştırmış olduk zeynep :)
                //hatayı newleyerek catch e gitti safak hanım :)
            ...
            System.out.println("yasin yetmiyor giris için " + illegal.getMessage());
        }
