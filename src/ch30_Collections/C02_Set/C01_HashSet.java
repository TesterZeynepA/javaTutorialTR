...
*/
        ...
        HashSet<String>hs = new HashSet<>();//boş bir hashset oluşturuldu
        ...
        System.out.println("hs1 = " + hs1);//hs1 = [null, meryem, sefa, tommy, eren, interface de, tanimlanir, emine, iclal, Meryem, ali]
        ...
        System.out.println("hs2.contains(\"method\") = " + hs2.contains("method"));//hs2.contains("method") = true

        System.out.println("hs2.hashCode() = " + hs2.hashCode());//hs2.hashCode() = 131891398
