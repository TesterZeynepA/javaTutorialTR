...
public class C01_LinkedList {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("linkedList1 = " + linkedList1);//linkedList1 = [berlin, ankara, sose, izmir, dortmund, istanbul, newyork, manheim]
        ...
        //polymophism e örnek olması için linkedList ve list kullanarak obje create ediniz

        List<String> linkedList2 = new LinkedList<>(Arrays.asList("zeynep", "iclal"));
