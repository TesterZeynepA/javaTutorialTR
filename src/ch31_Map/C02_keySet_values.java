 ...
 */
    public static void main(String[] args) {
        ...
        System.out.println("hm = " + hm);//hm = {null=125 $, Apple=250 $, null=null, Hp=200 $, Casper=101 $, Samsung=200 $, Huawei=150 $}
        ...
        System.out.println("hm.keySet() = " + hm.keySet());//hm.keySet() = [null, Apple, null, Hp, Casper, Samsung, Huawei]

        System.out.println("hm.values() = " + hm.values());//hm.values() = [125 $, 250 $, null, 200 $, 101 $, 200 $, 150 $]
