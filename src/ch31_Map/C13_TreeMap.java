 ...
 */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("tm = " + tm);//tm = {1000=Omer, 1001=emine, 1002=eren, 1003=derya}
       ...
       //RTE System.out.println("tm.put(null, \"Run time\") = " + tm.put(null, "Run time"));
        ...
        System.out.println("map = " + map);//map = {Apple=250 $, Hp=200 $, Casper=101 $, Samsung=200 $, Huawei=150 $}

        //ikinci treemap create edildi

        TreeMap<String, String> tm1 = new TreeMap<>(map);

        System.out.println("tm1 = " + tm1);//tm1 = {Apple=250 $, Casper=101 $, Hp=200 $, Huawei=150 $, Samsung=200 $}
       ...
       //CTE  TreeMap<String, String> tm2 = map;
        ...
        System.out.println("tm.ceilingKey(999) = " + tm.ceilingKey(999));//tm.ceilingKey(999) = 1000
...
//Descending order ise tam tersine, verilerin büyükten küçüğe doğru sıralandığı durumu ifade eder.
        ...
        //tm.descendingKeySet() = [1003, 1002, 1001, 1000]

        System.out.println("tm.keySet() = " + tm.keySet());//tm.keySet() = [1000, 1001, 1002, 1003]
        System.out.println("tm.firstKey() = " + tm.firstKey());//tm.firstKey() = 1000
        System.out.println("tm.lastKey() = " + tm.lastKey());//tm.lastKey() = 1003
