...
public class C01_PassByValue_Reference {
    public static void main(String[] args) {
        ...
        Bir  primitive  variable  argument olarak bir methoda call edildiğinde
        variable
...
veya mobilyalarında değişiklik yapar. Bu değişiklikler doğrudan
 ...
 evinize etki eder.
        ...
        System.out.println("method call sonrasi x değer " + x);//10

        //değer tipi değişken değiştirme

        changeString(s);

        System.out.println("method call sonrası s = " + s);
        ...
        System.out.println("method call sonrası fiyat = " + fiyat);//method call sonrası fiyat = 100.0
    ...
    private static void fiyatArttir(double fiyat) {
        ...
        System.out.println("method içinden fiyat = " + fiyat);//method içinden fiyat = 124.0
    ...
    private static void changeString(String s) {
        ...
        s= "world";
        System.out.println("method içinden s = " + s);
    ...
    private static void incrementInt(int x) {
        ...
        System.out.println("incrementInt methodu icinden x değeri " + x);//20
