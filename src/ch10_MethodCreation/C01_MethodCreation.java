...
// task01 -> iki tane int değer alan toplayıp return eden method create ediniz.
    ...
    return toplam;// en sonda olmalı return.
    ...
    private static void topla() {// method create edildi
        ...
        int b =44;
        System.out.println(a+b);
        System.out.println("topla isimli method calişti");
