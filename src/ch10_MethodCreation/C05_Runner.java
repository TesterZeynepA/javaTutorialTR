...
public class C05_Runner {
    ...
    1. method static --> gökteki güneş gibi, uzaydaki yıldız
    ...
    public static void main(String[] args) {// lokomotif olacak yani diğer

        // TASK kullanıcı ismini alıp crud işlemleri yapann farklı bir claas da methodları olan bir app create ediniz.
