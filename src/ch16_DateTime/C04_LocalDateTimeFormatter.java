...
a yazarsak AM veya PM degerini yazar
        ...
        */
        ...
        System.out.println("ldt = " + ldt);//ldt = 2023-07-06T21:05:17.347342100

        //istenen format 02/23/2023

        DateTimeFormatter format = DateTimeFormatter.ofPattern("MM/dd/yyyy");

        System.out.println("ldt.format(format) = " + ldt.format(format));//ldt.format(format) = 07/06/2023

        System.out.println("format.format(ldt) = " + format.format(ldt));//format.format(ldt) = 07/06/2023
        ...
        //formatTime.format(ldt.plusHours(2)) = 23:11:07

        System.out.println("ldt.format(formatTime) = " + ldt.format(formatTime));//ldt.format(formatTime) = 21:11:07
