...
//task-> girilen tamsayının asal olmasını kontrol eden code create ediniz
        ...
        //asal tamsayı = 1 ve kendisinden başka tam böleni olmayan sayılar
        ...
        for (int i = 2; i < sayi; i++) {
            ...
            if (sayi%i == 0) {
                ...
                System.out.println(sayi + " sayisi asal değil");
                asalMi = false;
...
Ardından, sayının asal olup olmadığı kontrol edilir ve sonuç kullanıcıya bildirilir.
 */
