...
4- İki adet parametreli const, 1 adet parametresiz cons olmak üzere 3 adet
 araba creat ediniz
  ...
  */
    ...
    public void setMotor(int motor) {
        ...
        if (motor<1000){
            ...
            System.out.println("findik kadar mi motor mu olur, yakitlar pahali galiba");
            this.motor = 1001;
        }else {
            this.motor =motor;
        }
    ...
    public void setYil(int yil) {
        ...
        if (yil<0){
            ...
            System.out.println("o yildaki arabanin burada ne işi var");
