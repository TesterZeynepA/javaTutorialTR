...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("enter your dob. format must be MM/dd/yyyy");
...
class Employees {
    ...
    public int ageCalculator(String dob) {//  08/23/1990
        ...
        LocalDate dogumTarihi = LocalDate.parse(dob, formatter);//kullanıcının girdiği String doğum tarihini LocalDate e çevirdi
        LocalDate bugun = LocalDate.now();
       return  bugun.getYear() - dogumTarihi.getYear();
    }
